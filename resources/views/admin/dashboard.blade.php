...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
            ...
            <a href="{{url('/admin')}}" class="list-group-item list-group-item-action bg-transparent second-text active fw-bold"><i
        ...
        <div id="page-content-wrapper">
            ...
            @if(Session::has('success'))
                ...
                <div class="row g-3 my-2">
                    <div class="col-md-6">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2 text-center">{{$count}}</h3>
                                <p class="fs-5">Total Quiz</p>
                            </div>
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Recent Added Quiz</h3>
                    <div class="col">
