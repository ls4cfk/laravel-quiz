...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
            ...
            <a href="{{url('admin/view-quiz')}}" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <th scope="row">{{++$key}}</th>
                                    ...
                                    <td><img src="{{asset('images/'.$quiz->quiz_image)}}" alt="" srcset="" width="100" height="100"></td>
                                    <td>{{$quiz->quiz_description}}</td>
                                    <td>{{$quiz->quiz_author}}</td>
                                    @if($quiz->quiz_accept == 1)
                                    <td>Active</td>
                                    @else
                                    <td>Inactive</td>
                                    @endif
                                    
                                    <td><a href="{{url('/admin/quizapproved/'.$quiz->id)}}">Approve</a> &nbsp;&nbsp; <a href="{{url('/admin/delete-quiz/'.$quiz->id)}}">DELETE </a> </td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
