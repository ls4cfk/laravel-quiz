...
<div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <form action="{{url('editquiz')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3 my-2">

                     <input type="hidden" name="quizid" value="{{$quiz->id}}" class="form-control">
                    <h4>Add New Quiz</h4>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="" class="" style="font-size:20px;font-weight:bold;">Name</label>
                            <input type="text" name="name" value="{{$quiz->quiz_name}}" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="image" value="{{$quiz->quiz_description}}" class="form-control">
                            <img src="{{asset('images/'.$quiz->quiz_image)}}" alt="" height="100" width="100">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" value="" class="form-control" id="" >{{$quiz->quiz_description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="author" value="{{$quiz->quiz_author}}" class="form-control">
                        </div>
                    </div>
