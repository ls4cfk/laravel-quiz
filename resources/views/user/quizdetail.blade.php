               ...
               <a href="{{url('/user/quiz-detail/'.$quiz->id)}}" style="text-decoration:none; "> <div class="row mb-5 pl-3" >
                    <div class="col-md-8 p-0" style="background: #142B2A;">
                        <div class="d-block mt-3">
                            ...
                            <div class="d-block p-2 mb-2 ">
                                <h4 class="bg-light d-inline-block text-center p-1" style="color:black">{{date('d-m-Y' , strtotime($quiz->created_at))}}</h4>
                            </div>
                        ...
                        <div class=" w-80 p-2">
                            ...
                            <div class="p-2">
                                <a href="{{url('user/starquiz/'.$quiz->id)}}"><button class="btn btn-primary">Start Quiz</button></a>
                            </div>
                        </div>
                    </div>
